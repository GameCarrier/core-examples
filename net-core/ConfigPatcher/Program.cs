...
namespace ConfigPatcher
{
    ...
    {
        private static readonly Dictionary<string, Func<string>> paramGetters = new()
        {
        ...
        private static readonly Dictionary<string, string> paramCache = new() { };
        ...
        {
            return ReadAttribute<AssemblyConfigurationAttribute>("Configuration");
        }
